...
@router.get("", response_model=schemas.Items, summary='查询物品')
...
@router.get("/{item_id}", response_model=schemas.Item, summary='根据id查询物品')
...
@router.put("/{item_id}", response_model= schemas.Item, responses={403: {"description": "Operation forbidden"}}, summary='修改物品')
